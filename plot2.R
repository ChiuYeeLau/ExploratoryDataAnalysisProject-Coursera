...
message ("0. Start Project 1-2 of Exploratory Data Analysis ~")
...
# Part 5: Plot'Global Active Power' vs Date & Time 
message ("5. Plot'Global Active Power' vs Date & Time ~")
...
# Part 7: Project 1-2 is done
message ("7. Project 1-2 of Exploratory Data Analysis is done ~")
